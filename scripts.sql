...
select cli.id, cli.nome as cliente, mcp.nome as municipio, uf.nome as uf from cliente cli left join municipio mcp on cli.idmunicipio = mcp.id l join uf on mcp.iduf = uf.id
...
create table fornecedor (
	...
	nome varchar(50) not null constraint unique
)
