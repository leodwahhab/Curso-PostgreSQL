...
alter table if exists profissao add constraint unique_profissao_nome unique (nome);
alter table if exists profissao alter column id add generated always as identity;
...
alter table if exists pedido_produto
